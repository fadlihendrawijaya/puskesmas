...
class RekamMedisController extends Controller
{
    ...
    public function hapus_rm($id)
    {
        ...
        return redirect ('rekamedis')->with('pesan', $pesan);
    }
       ...
       if (isset($request->resep))
        ...
        DB::table('rm')->where('id',$request->id)->update([
            ...
            switch($request->simpan) {
                case 'simpan_edit': 
                    $buka=url('rekamedis/edit/'. $request->id);
                    $pesan='Data Rekam Medis berhasil disimpan!';
                break;             
                case 'simpan_baru': 
                    $buka=route('rekamedis.tambah.id',$request->idpasien);
                    $pesan='Data Rekam Medis berhasil disimpan!';
                break;
            }
    ...
    public function edit_rm($id)
    {
      ...
      return view('rekamedis.edit',compact('metadatas','idens','datas','labs','obats','num'));
    }
    ...
    public function list_rm($idpasien)
    {
        ...
        return view('rekamedis.list',compact('metadatas','idens','rms'));
    ...
    public function tambah_rm()
    {
        ...
        return view('rekamedis.tambah',compact('metadatas','pasiens','cont'));  
    }
        ...
        public function tambah_rmid($idpasien)
    {
        ...
        return view('rekamedis.tambah',compact('metadatas','idens','pasiens','cont','labs','obats','dokters'));  
    }
       ...
       if (isset($request->resep))
        ...
        DB::table('rm')->insert([
           ...
           $ids= DB::table('rm')->latest('created_time')->first();         
            switch($request->simpan) {
                case 'simpan_edit': 
                    $buka=url('rekamedis/edit/'. $ids->id);
                    $pesan='Data Rekam Medis berhasil disimpan!';
                break;             
                case 'simpan_baru': 
                    $buka=route('rekamedis.tambah.id',$request->idpasien);;
    ...
    public function tagihan($id)
    {
        ...
        return view('rekamedis.tagihan',compact('metadatas','idens','items'));      
        ...
        public function lihat_rm($id)
    {
        ...
        $obats = ambil_semuadata('obat');
        $idens=DB::table('pasien')->where('id',$idpasien)->get();
      return view('rekamedis.lihat',compact('metadatas','idens','datas','labs','obats','num'));
    }
}